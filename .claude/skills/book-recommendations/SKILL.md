...
If the user does not mention it, ask which genre. If there is no live user turn to ask (e.g. an automated or eval run), default to contemporary and state that the default was applied.
